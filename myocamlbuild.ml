...
(*       flag ["ocaml"; "link"; "program"; "native"] & S[A"-ccopt" ; A"-static"]; *)
       ...
       (* now a rule for atdgen *)
       rule "atdgen compilation"
        ~prods:["%.ml" ; "%.mli"]
        ~dep:"%.atd"
        begin fun env _build ->
          ...
          let tags = tags_of_pathname atd++"compile"++"atdgen" in
          ...
          Cmd(S[A"atdgen"; T tags; A"-json" ; A"-std-json" ; P atd])
        end;
